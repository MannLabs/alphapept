...
pkgbuild --root dist/alphapept --identifier de.mpg.biochem.alphapept.app --version 0.4.0 --install-location /Applications/alphapept.app --scripts scripts alphapept.pkg
