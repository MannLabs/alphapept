...
pkgbuild --root dist/alphapept --identifier de.mpg.biochem.alphapept.app --version 0.3.29 --install-location /Applications/alphapept.app --scripts scripts alphapept.pkg
