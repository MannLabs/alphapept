...
pip install "../../dist/alphapept-0.4.4-py3-none-any.whl[stable,gui-stable]"
...
pkgbuild --root dist/alphapept --identifier de.mpg.biochem.alphapept.app --version 0.4.4 --install-location /Applications/alphapept.app --scripts scripts alphapept.pkg
