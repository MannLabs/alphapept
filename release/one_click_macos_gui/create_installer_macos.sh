...
pkgbuild --root dist/alphapept --identifier de.mpg.biochem.alphapept.app --version 0.3.30 --install-location /Applications/alphapept.app --scripts scripts alphapept.pkg
