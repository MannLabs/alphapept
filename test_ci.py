...
class TestRun():
    ...
    """
    def __init__(self, id, experimental_files, fasta_paths, new_files, fractioned_samples = None,custom_settings = None):

        self.id = id
        self.file_paths = experimental_files
        self.fasta_paths = fasta_paths
        self.new_files = new_files
        self.fractioned_samples = fractioned_samples
...
def main(runtype = None, password = None, new_files = True):
    ...
    if runtype == 'bruker_irt':
        ...
        fasta_files = ['human.fasta', 'contaminants.fasta']
        fractioned_samples = {'Hela_P035210_BA1_S00_A00': ['Hela_P035210_BA1_S00_A00_R1.raw', 'Hela_P035210_BA1_S00_A00_R5.raw', 'Hela_P035210_BA1_S00_A00_R14.raw', 'Hela_P035210_BA1_S00_A00_R19.raw']}
        run = TestRun(runtype, files, fasta_files, new_files, fractioned_samples = fractioned_samples)
