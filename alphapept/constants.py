...
__all__ = ['AAs', 'mass_dict', 'get_mass_dict', 'Isotope', 'spec', 'isotopes', 'averagine_aa', 'averagine_avg',
           'protease_dict', 'loss_dict', 'TAG', 'label_dict']
...
import numpy as np
TAG = namedtuple('tag', ['mod_name', 'channels', 'masses', 'reference_channel','mods_fixed_terminal','mods_variable'])

label_dict = {}

label_dict['TMT10plex'] = TAG('tmt6',
    ['tmt10-126',
 'tmt10-127N',
 'tmt10-127C',
 'tmt10-128N',
