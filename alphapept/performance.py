# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/13_performance.ipynb (unless otherwise specified).

__all__ = ['COMPILATION_MODE_OPTIONS', 'COMPILATION_MODE', 'is_valid_compilation_mode', 'set_worker_count',
           'MAX_WORKER_COUNT', 'set_compilation_mode', 'compile_function', '__copy_func', 'DYNAMIC_COMPILATION_ENABLED',
