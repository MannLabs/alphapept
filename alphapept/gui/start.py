...
def start():
    ...
    with st.beta_expander('Navigation'):
        ...
        st.write('- Status: Displays the current processing status.'
    ...
    with st.beta_expander('Resources'):
        st.write('On the following pages you can find additional information about AlphaPept:')
        ...
        markdown_link('Report an issue or suggest a feature (GitHub)', 'https://github.com/MannLabs/alphapept/issues/new/choose')
        markdown_link('Installation manual', 'https://github.com/MannLabs/alphapept')
        markdown_link('Understanding column names', "https://github.com/MannLabs/alphapept")
        markdown_link('Version performance', "https://charts.mongodb.com/charts-alphapept-itfxv/public/dashboards/5f671dcf-bcd6-4d90-8494-8c7f724b727b")
        markdown_link('Contact (e-mail)', f"mailto:opensource@alphapept.com?subject=AlphaPept({VERSION_NO})")

    with st.beta_expander('Server'):

        st.write("When starting AlphaPept you launch a server that can be closed when closing the terminal window.")
