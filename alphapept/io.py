# AUTOGENERATED! DO NOT EDIT! File to edit: 02_io.ipynb (unless otherwise specified).

__all__ = ['get_most_abundant', 'load_thermo_raw', 'raw_to_npz', 'check_sanity', 'extract_mzml_info',
           'extract_mzxml_info', 'read_mzML', 'read_mzXML', 'list_to_numpy_f32', 'save_as_npz']
...
# Cell
def load_thermo_raw(raw_file, most_abundant, **kwargs):
    """
...
def raw_to_npz(kwargs):
    ...
    if isinstance(path, list):
        for raw_file in tqdm(path):
            scan_list_ms1, rt_list_ms1, mass_list_ms1, int_list_ms1, ms_list_ms1, scan_list_ms2, rt_list_ms2, mass_list_ms2, int_list_ms2, ms_list_ms2, prec_mass_list2, mono_mzs2, charge2 = load_thermo_raw(raw_file, **kwargs)
