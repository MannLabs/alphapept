...
d = { 'settings': { 'branch': 'master',
                'doc_baseurl': '/',
                'doc_host': 'https://mannlabs.github.io/alphapept',
  ...
  'syms': { 'alphapept.additional_code': {},
            'alphapept.chem': { 'alphapept.chem.IsotopeDistribution': ('chem.html#isotopedistribution', 'alphapept/chem.py'),
                                'alphapept.chem.IsotopeDistribution.__init__': ('chem.html#__init__', 'alphapept/chem.py'),
                                'alphapept.chem.IsotopeDistribution.add': ('chem.html#add', 'alphapept/chem.py'),
                                'alphapept.chem.IsotopeDistribution.copy': ('chem.html#copy', 'alphapept/chem.py'),
                                'alphapept.chem.IsotopeDistribution.mult': ('chem.html#mult', 'alphapept/chem.py'),
            ...
            'alphapept.constants': { 'alphapept.constants.Isotope': ('constants.html#isotope', 'alphapept/constants.py'),
                                     'alphapept.constants.Isotope.__init__': ('constants.html#__init__', 'alphapept/constants.py'),
            ...
            'alphapept.io': { 'alphapept.io.HDF_File': ('io.html#hdf_file', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.__eq__': ('io.html#__eq__', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.__hash__': ('io.html#__hash__', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.__init__': ('io.html#__init__', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.__repr__': ('io.html#__repr__', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.__str__': ('io.html#__str__', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.check': ('io.html#check', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.creation_time': ('io.html#creation_time', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.directory': ('io.html#directory', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.file_name': ('io.html#file_name', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.is_overwritable': ('io.html#is_overwritable', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.is_read_only': ('io.html#is_read_only', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.last_updated': ('io.html#last_updated', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.original_file_name': ('io.html#original_file_name', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.read': ('io.html#hdf_file.read', 'alphapept/io.py'),
                              'alphapept.io.HDF_File.version': ('io.html#version', 'alphapept/io.py'),
